...
export default function FAB({ onPress, style }: { onPress: () => void; style?: ViewStyle }) {
  return (
    <Pressable onPress={onPress} style={({ pressed }) => [S.fab, style, pressed && { transform: [{ scale: 0.98 }] }]}>
...
const S = StyleSheet.create({
  fab: {
    width: 56, height: 56, borderRadius: 28, bottom:20,
    backgroundColor: '#6F5AE6', alignItems: 'center', justifyContent: 'center',
