...
export const useStyles = makeStyles((t) =>
  StyleSheet.create({
    ...
    iconActive: {
      ...
      backgroundColor: alpha(t.colors.tint, 0.16)
    },
    rateBlock: {
      marginTop: 8,
      alignItems: 'center',
    ...
    rateStrong: {
      fontSize: t.typography.numStrongLarge,
      fontWeight: t.typography.numStrong as any,
      color: t.colors.text,
    ...
    statPill: {
      ...
      justifyContent: 'center',
      borderWidth: 1,
      borderColor: alpha(t.colors.border, 0.7),
